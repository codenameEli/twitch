...
// // END UberMenu Force Open Menu Items for Styling
    ...
    var slickCubeRotator = {
        ...
        {
          $('.hero-slideshow-container .slick-slide').removeClass('cube-top cube-front cube-bottom cube-back');
        },
        ...
        addEventListeners: function()
        {
            ...
            $('.hero-slideshow-container').on('init', function(event, slick) {
                ...
                slick.slickSetOption('speed', 1000, true);
            });

            $('.hero-slideshow-container').on('beforeChange', function(ev, slick, currentSlide, nextSlide) {
            ...
            $('.hero-slideshow-container').on('afterChange', function(ev, slick, currentSlide) {
                ...
                if ( currentSlide % 4 === 1 ) {
                    ...
                    console.log('else if ( currentSlide === 7 ) {');
                    $currentSlide.addClass('cube-back');
                    $prevSlide.addClass('cube-bottom');
                    $nextSlide.addClass('cube-top');
                    $lastSlide.addClass('cube-front');
